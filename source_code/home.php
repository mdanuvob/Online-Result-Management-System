...
<body>
	...
	<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
	  ...
	  <div class="carousel-inner">
		<div class="carousel-item active">
		  <img src="pic/ewu.jpg" class="d-block w-100 h-100" alt="...">
		</div>
		<div class="carousel-item">
		  <img src="pic/ewu1.jpg" class="d-block w-100 h-100" alt="...">
		</div>
		<div class="carousel-item">
		  <img src="pic/ewu2.jpg" class="d-block w-100 h-100" alt="...">
		</div>
	  </div>
	...
	<div class="row">
	  <div class="col"></div>
	  <div class="col">
	  		<h4>welcome to east wast University</h4>
	</div>
	  <div class="col"></div>
	</div> 
