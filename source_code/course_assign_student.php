...
if(isset($_REQUEST["submit_2"]))
{
	...
	foreach($chk as $id)
	{
	$sql_2 = "insert into takes  values('$value_1','$value_2','$id')";
    $result_2= mysqli_query($connection, $sql_2);

    $sql_3 = "insert into result(course_code,course_section,id) values('$value_1','$value_2','$id')";
    $result_3= mysqli_query($connection, $sql_3);

    $sql_4 = "insert into grade_result(course_code,course_section,s_id) values('$value_1','$value_2','$id')";
...
<table align="center" border="1">
	...
	<tr>
		<td>Student's Id</td>
		<td><input type="submit" name="submit_2" value="Assign Course"></td>
	</tr>
<?php
