...
<div class="wrapper">
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="delete_student.php"><i class="fas fa-project-diagram"></i>Drop Student</a></li>
    ...
    <div class="main_content">
        ...
        <div class="info">
          <div><h5>An admin can assign cousre to faculty and student and drop course from student</h5></div>
      </div>
    </div>
</div>